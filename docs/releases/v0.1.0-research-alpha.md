...
- `docs/releases/v0.1.0-research-alpha-validation-report.json`
- `docs/releases/v0.1.0-research-alpha-sbom.json`
...
The canonical public project identity is `https://cosmos-cqa.org`. Redirect domains are `cosmoscqa.org`, `cosmos-cqa.com`, and `cosmoscqa.com`.

The first Zenodo DOI is planned for the next clean public research alpha release after repository registration with Zenodo. Do not cite a DOI for this release unless a Zenodo record is later created explicitly for this tag.
