...
- emits deterministic, caveated diagnostic placeholders for testing report plumbing and future expert review planning.
- provides optional, user-initiated sonification sidecars as review aids within documented audio safety boundaries.
...
- validates kappa-y, E/B, foreground, lensing, or survey-calibration diagnostics.

Do not claim:

- autonomous scientific validation;
- that placeholder diagnostics are scientific measurements, physical E/B separation, foreground evidence, lensing-quality evidence, or survey-performance evidence;
- that sonic loops are therapeutic, medical, biologically active, diagnostic, signal-discovery, or scientific-measurement systems;
