...
- consumes only synthetic Core Pack fixture metadata such as tile coordinates, checksums, and dataset ids;
...
- consumes only synthetic Core Pack fixture metadata such as tile ordering, checksums, truth-label mix, and dataset ids;
- emits deterministic unitless components for replay and report plumbing;
