...
Zenodo DOI status and release citation guidance lives in [docs/zenodo-registration.md](docs/zenodo-registration.md). The all-versions Zenodo DOI is [10.5281/zenodo.21112698](https://doi.org/10.5281/zenodo.21112698); the first archived release DOI for `v0.1.1-research-alpha` is [10.5281/zenodo.21112699](https://doi.org/10.5281/zenodo.21112699). The `v0.1.2-research-alpha` version DOI is pending Zenodo ingestion from the GitHub release.
