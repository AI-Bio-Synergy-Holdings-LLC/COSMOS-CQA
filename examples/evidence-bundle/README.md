...
- `core-pack-evidence-bundle-golden.json` pins the deterministic serialized evidence bundle generated from the sample Core Pack, diagnostics, SBOM reference, provenance hashes, and validation report.
