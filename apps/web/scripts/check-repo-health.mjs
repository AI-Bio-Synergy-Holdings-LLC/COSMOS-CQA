...
const guardrails = [
  ...
  {
    path: "docs/private-application-transition-map.md",
    label: "private application transition map",
    phrases: [
  ...
  {
    path: "docs/private-application-readiness-gates.md",
    label: "private application readiness gates",
    phrases: [
