...
test("hosted demo path preloads the synthetic Core Pack fixture with public boundaries", async ({ page }) => {
  ...
  await expect(page.locator("#tilePassportDetails")).toContainText("synthetic fixture version; portal v0.1.4-research-alpha");
  await expect(page.locator("#tilePassportDetails")).toContainText("Public truth labels hidden");
  await expect(page.locator("#corePackManifestSummary")).toContainText("synthetic fixture version; portal v0.1.4-research-alpha");
